...
-- Las tablas medication.medications y medication.dose_schedules
-- las crea SCRUM-115 (Jesus). Este endpoint (SCRUM-112) asume que
-- ya existen con la forma que espera medication.model.js / dose-schedule.model.js.
